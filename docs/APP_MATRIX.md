...
| Application | Native path | Default result | Optional fallback |
| --- | --- | --- | --- |
...
| Windows | `.theme` file plus per-user cursor scheme | Dark system/app mode, Pride wallpaper, violet accent, and rainbow pointers | None required |
